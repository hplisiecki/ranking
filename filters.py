...
links_failed = publications_with_links[publications_with_links.automatic_pdf_download == 0].link.values


pdf_sites_list = []
pdf_download_list = []
manual_checking_list = []
text_scraping_list = []
slipped_through_list = []
for link in links_failed:
    try:
        ...
        if 'Psychiatria Polska' in soup.text:
            ...
            pdf_link = pdf[0]['href']
            pdf_sites_list.append(pdf_link)
            continue
        ...
        ###############################
            ...
            pdf_download_list.append(pdf_link)
            continue
        ...
        ###############################
            ...
            text_scraping_list.append(driver.current_url)
            continue
        ...
        ###############################
            ...
            manual_checking_list.append(link)
            continue
        ...
        slipped_through_list.append(link)
